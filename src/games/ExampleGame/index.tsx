  ...
  return (
    <>
      ...
      <GambaUi.Overlay>
        ...
        <GambaUi.Button onClick={click} disabled={!game.connected}>
          {fightEnded ? 'Play Again' : 'Start Fight'}
        </GambaUi.Button>
        {!fightEnded && (
          <GambaUi.Button onClick={toggleChicken}>
            Toggle Chicken ({selectedChicken === 'black' ? 'Black' : 'White'})
          </GambaUi.Button>
        )}
      </GambaUi.Overlay>
    </>
